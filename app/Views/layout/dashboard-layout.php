...
<head>
  ...
  <link rel="stylesheet" href="datatable/css/jquery.dataTables_themeroller.min.css">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= route_to('user.profile')?>" class="d-block"><?= ucfirst($userInfo['name']); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= route_to('countries') ?>" class="nav-link <?= (current_url() == base_url('user/member')) ? 'active' : ''; ?>">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022 <a href="<?= base_url(); ?>">Mr.Shin</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
